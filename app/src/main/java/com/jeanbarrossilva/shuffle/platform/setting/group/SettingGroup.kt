package com.jeanbarrossilva.shuffle.platform.setting.group
...
import com.jeanbarrossilva.shuffle.platform.setting.Setting
import com.jeanbarrossilva.shuffle.platform.setting.SettingDefaults
import com.jeanbarrossilva.shuffle.platform.setting.extensions.forwardsNavigationArrow
import com.jeanbarrossilva.shuffle.platform.setting.extensions.reversed
        ...
        SettingGroup(
            ...
            repeat(4) { index ->
                setting(
                    ...
                    action = {
                        Icon(
                            ShuffleTheme.Icons.forwardsNavigationArrow,
